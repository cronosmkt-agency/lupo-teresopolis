...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lupo Teresópolis — Franquia Oficial na Duque de Caxias | Pronta Entrega" },
      { name: "description", content: "Linha térmica de inverno, segunda pele, meias felpudas, Lupo Sport e pijamas com pronta entrega e retirada rápida na Duque de Caxias, 90." },
      { property: "og:title", content: "Lupo Teresópolis — Loja Exclusiva" },
      { property: "og:description", content: "O conforto e a tecnologia da Lupo com pronta entrega em Teresópolis." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#18181b'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>LP</text></svg>" },
